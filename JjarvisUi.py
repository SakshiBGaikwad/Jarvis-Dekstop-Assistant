...
class Ui_jarvisUi(object):
    def setupUi(self, jarvisUi):
        ...
        jarvisUi.resize(1150, 868)
        self.centralwidget = QtWidgets.QWidget(jarvisUi)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(0, 0, 1161, 861))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("D:/Wallpaper/7LP8.gif"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(860, 760, 111, 51))
        font = QtGui.QFont()
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(970, 760, 111, 51))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_2.setGeometry(QtCore.QRect(0, 0, 511, 191))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("D:/Wallpaper/T8bahf.gif"))
        self.label_2.setObjectName("label_2")
        self.textBrowser = QtWidgets.QTextBrowser(self.centralwidget)
        self.textBrowser.setGeometry(QtCore.QRect(545, 10, 291, 71))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
...
"font-size:20px")
        ...
        self.textBrowser_2.setGeometry(QtCore.QRect(840, 10, 291, 71))
...
"font-size:20px")
        ...
        self.label_3.setGeometry(QtCore.QRect(794, 510, 321, 191))
        self.label_3.setText("")
        self.label_3.setPixmap(QtGui.QPixmap("D:/Wallpaper/images.png"))
